 ...
 * respective owners.]
 *
 * ---------------------- MouseWheelHandler.java ---------------------- (C) Copyright 2009-2014 by Object Refinery
 * Limited and Contributors.
 *
 * Original Author: David Gilbert (for Object Refinery Limited); Contributor(s): Ulrich Voigt - patch 2686040; Jim
 * Goodwin - bug fix;
 *
 * Changes ------- 18-Mar-2009 : Version 1, based on ideas by UV in patch 2686040 (DG); 26-Mar-2009 : Implemented
 * Serializable (DG); 10-Sep-2009 : Bug fix by Jim Goodwin to respect domain/rangeZoomable flags in the ChartPanel (DG);
...
class MouseWheelHandler implements MouseWheelListener, Serializable {
     ...
     */
    MouseWheelHandler(final CustomChartPanel chartPanel) {
