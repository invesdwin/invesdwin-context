...
@NotThreadSafe
public class WrappedCombinedDomainXYPlot extends WrappedXYPlot implements ICombinedPlot {

    public WrappedCombinedDomainXYPlot(final CombinedDomainXYPlot plot) {
        super(plot);
    }
