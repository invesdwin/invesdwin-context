/*
 * Copyright (c) 2005, 2017, Oracle and/or its affiliates. All rights reserved. DO NOT ALTER OR REMOVE COPYRIGHT NOTICES
 * OR THIS FILE HEADER.
 *
...
/**
 * The Generated annotation is used to mark source code that has been generated. It can also be used to differentiate
 * user written code from generated code in a single file.
 *
 * <h3>Examples:</h3>
 * 
 * <pre>
...
public @interface Generated {
    ...
    /**
     * The value element MUST have the name of the code generator. The name is the fully qualified name of the code
     * generator.
     *
    ...
    /**
     * Date when the source was generated. The date element must follow the ISO 8601 standard. For example the date
     * element would have the following value 2017-07-04T12:08:56.235-0700 which represents 2017-07-04 12:08:56 local
