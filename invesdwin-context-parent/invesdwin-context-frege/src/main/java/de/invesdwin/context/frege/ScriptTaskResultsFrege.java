...
@NotThreadSafe
public class ScriptTaskResultsFrege implements IScriptTaskResults {

    private final ScriptTaskEngineFrege engine;

    public ScriptTaskResultsFrege(final ScriptTaskEngineFrege engine) {
        this.engine = engine;
    }

    @Override
    public ScriptTaskEngineFrege getEngine() {
        return engine;
    }
