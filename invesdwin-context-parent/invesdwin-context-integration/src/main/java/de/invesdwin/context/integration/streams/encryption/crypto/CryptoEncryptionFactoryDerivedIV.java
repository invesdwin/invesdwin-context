 ...
 */
@Immutable
public class CryptoEncryptionFactoryDerivedIV implements IEncryptionFactory {
    ...
    public CryptoEncryptionFactoryDerivedIV(final ICryptoAlgorithm algorithm, final byte[] derivedKey,
