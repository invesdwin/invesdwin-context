...
public class CryptoEncryptionFactory extends CryptoEncryptionFactoryDerivedIV {
    ...
    public CryptoEncryptionFactory(final DerivedKeyProvider derivedKeyProvider) {
        this(AesAlgorithm.DEFAULT, derivedKeyProvider);
    }

    public CryptoEncryptionFactory(final ICryptoAlgorithm algorithm, final DerivedKeyProvider derivedKeyProvider) {
