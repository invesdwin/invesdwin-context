 ...
 */
@Immutable
public class CryptoEncryptionFactoryCountedIV implements IEncryptionFactory {
    ...
    public CryptoEncryptionFactoryCountedIV(final ICryptoAlgorithm algorithm, final byte[] key) {
    ...
    protected void calculateIV(final byte[] iv) {
        CryptoEncryptionFactoryDerivedIV.calculateIV(initIV, ivCounter.incrementAndGet(), iv);
    }
