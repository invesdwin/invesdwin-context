 ...
 */
@Immutable
public class AesEncryptionFactoryPresharedIV implements IEncryptionFactory {
    ...
    public AesEncryptionFactoryPresharedIV(final AesAlgorithm algorithm, final byte[] key, final byte[] presharedIv) {
