package de.invesdwin.context.jruby.tests.callback;
...
import de.invesdwin.context.jruby.tests.hello.HelloWorldScript;
...
public class ParametersAndReturnsTests {
    ...
    public ParametersAndReturnsTests(final IScriptTaskRunnerJruby runner) {
        this.runner = runner;
    }
