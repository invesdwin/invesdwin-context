...
@NotThreadSafe
public class ScriptTaskResultsJruby implements IScriptTaskResults {

    private final ScriptTaskEngineJruby engine;

    public ScriptTaskResultsJruby(final ScriptTaskEngineJruby engine) {
        this.engine = engine;
    }

    @Override
    public ScriptTaskEngineJruby getEngine() {
        return engine;
    }
